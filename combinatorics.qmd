...
-   There are ${}_{10}C_2 = 10!/(2!8!) = 45$ unordered ways to choose 2 men from among 10 male applicants and ${}_3C_5 = 5!/(3!2!) = 10$ ways to choose 3 women[^combinatorics-2] from among the remaining 5 applicants, so we have $n(\mathcal{A}) = 45 \cdot 10 = 450$.
...
[^combinatorics-2]: Or non-binary pilots!
